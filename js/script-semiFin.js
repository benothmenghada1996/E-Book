...
function dynamicHeader(){
    ...
    if (connectedUserId){
        ...
        <div style="margin-left: 3%;">
            <a href="Home.html" onclick ="signOut()"><i class="fa fa-sign-out fa-lg "></i> Sign-Out</a>
        </div>`
        }   
    }
    else {
...
// Ajout des maisons par un owner (addHouse-Dash.html)
...
// function cancelReservByIndex(index){
//     var reservationsTab = JSON.parse(localStorage.getItem("reservations"));
//         reservationsTab.splice(index,1);
//         localStorage.setItem("canceledReserv",reservationsTab[index].id);   
//         location.reload();
// }
// function cancelReservById(key,id){
//     var T = JSON.parse(localStorage.getItem(key));
//     var position
//     for (let i = 0; i < T.length; i++) {
//       if (T[i].id === id) {
...
//     }
//     T.splice(position, 1)
//     localStorage.setItem("canceledReserv", id)
//     window.location.reload()
// }
...
function CancelReservation(id) {
    var reservationsTab=JSON.parse(localStorage.getItem("reservations") );
    // Parcourir le tableau de réservations
    for (let i = 0; i < reservationsTab.length; i++) {
      // Vérifier si l'ID de la réservation correspond à l'ID spécifié
      if (reservationsTab[i].id === id) {
    ...
    //   else {
    //     alert("Réservation not founded.");}
    }
}
function cancelReservById(id){   
    const messageElement = document.getElementById("reservId").innerHTML="";
    alert("Your reservation was successfully cancelled !");  
        // messageCancel = "Your reservation"+ reservation.id + "was cancelled !";
